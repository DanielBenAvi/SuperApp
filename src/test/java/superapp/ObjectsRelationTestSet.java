...
public class ObjectsRelationTestSet extends BaseTestSet {
    ...
    public void invalidGetChildrenUrlTest() {
        ...
        // create relation
        this.putRelationBetweenObjects(this.springApplicationName
        ...
        SuperAppObjectBoundary[] parents = this.getRelationParents(this.springApplicationName
        ...
        SuperAppObjectBoundary[] children = this.getRelationChildren(this.springApplicationName
                , postedObjectParent.getObjectId().getInternalObjectId());
    ...
    @Test
    @DisplayName("Successfully bind relation between 2 objects children to parent")
    ...
    @Test
    @DisplayName("Bind non existing object to parent")
    public void test_7() {
    ...
    public void getParentOfChildTest() {
        ...
        SuperAppObjectBoundary[] parentOfChild1 = this.getRelationParents(this.springApplicationName
                , postedObjectChild_1.getObjectId().getInternalObjectId());

        // WHEN
        // A GET request is made to the path
        // "superapp/objects/2023b.LiorAriely/postedObjectChild_2--internalObjectId/parents"
        SuperAppObjectBoundary[] parentOfChild2 = this.getRelationParents(this.springApplicationName
                , postedObjectChild_2.getObjectId().getInternalObjectId());
    ...
    public void getParentWithoutChildrenTest() {
        ...
        SuperAppObjectBoundary[] parents = this.getRelationParents(this.springApplicationName
                                                                    , postedObject.getObjectId().getInternalObjectId());
